...
masterUrl = 'https://www.justice.gov/enrd/selected-publications/environmental-crimes-monthly-bulletins'
...
def create_website_folder(url):
    ...
    folder = domain_name.replace(".", "_") + '_enviromental'
...
if __name__ == '__main__':
    logger.info('Starting script- justice_gov_enviromental.py')
    t1 = time.time()
    try:
