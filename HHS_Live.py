...
log_name = 'HHS_Live.logs' # Log file name 
...
def getESdetails():
    ...
    print("Latest Article In the ES:", latest_article)
    ...
    try:
        ...
        for li in li_elements:
            ...
            if anchor_element:  # Check if the anchor tag exists
                ...
                PressTitles = (content)
                if PressTitles == latest_article:
                    print('Okay with Data, Now We Are Up to Date')
                    break
...
if __name__ == '__main__':
    ...
    logger.info('Starting script- hhsLiveScript.py')
    t1 = time.time()
    try:
